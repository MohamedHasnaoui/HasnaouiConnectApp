...
<div class="flex flex-col p-6 w-[280px] gap-4 items-center bg-[#F8FAFC] rounded-xl shadow-sm h-fit" >
    ...
    <div class="text-center">
        ...
        <p class="text-[#4F46E5] font-semibold text-[16px]">{{$role}}</p>
    </div>
    <p class="text-[#475569] font-normal text-[16px] text-center">hi I am user of HasnaouiConnect app don't hesitate to send me a message</p>
